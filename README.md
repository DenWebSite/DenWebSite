...
Сфокусирован на Frontend разработке на **Vue3** + **Nuxt4**. А ещё начинаю разбираться в Backend разработке на **Node.js** + **Express.js**.
...
#### Подробнее - на https://denwebsite.vercel.app/
***
...
#### Data
![Postgres](https://img.shields.io/badge/postgres-%23316192.svg?style=for-the-badge&logo=postgresql&logoColor=white)  ![SQL](https://img.shields.io/badge/SQL-4479A1?logo=SQL&logoColor=white&style=for-the-badge)
...
#### Ссылка: https://arthouse-alushta.ru
...
#### Ссылка: https://github.com/DenWebSite/Movie-Watchlist-API
...
#### Key Achievements:
* Построение Базы данных и связей между таблицами
* Prisma для работы с БД 
* Опыт обработки эндпоинтов и настройки middleware
* Работа с JWT и запись токена в cookies
